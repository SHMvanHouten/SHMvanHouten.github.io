describe("YahtzyGame", function () {
	...
	it("should give a score of 0 when small straight is chosen", function () {
		var game = new YahtzyGame(1, 2, 3, 5, 6);
